DMS="DM0_pTlow DM1_pTlow DM10_pTlow DM11_pTlow DM0_pThigh DM1_pThigh DM10_pThigh DM11_pThigh"
VARS="m_vis m_2"
YEAR="UL2018"
NPOINTS="41"
RANGE="0.970,1.030"
...
FIT_OPTS="--robustFit=1 --setRobustFitAlgo=Minuit2 --setRobustFitStrategy=0 --setRobustFitTolerance=0.001" #--preFitValue=1. 
