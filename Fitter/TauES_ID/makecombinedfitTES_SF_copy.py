...
def merge_datacards_regions(setup, config_mumu, era, extratag):
    ...
    for region in setup[variable]["fitRegions"]:
...
def run_combined_fit(setup, setup_mumu, option, **kwargs):
    ...
    npts_fit     = kwargs.get('npts_fit',     "--points=2601")
