...
def main(args):
    ...
    compare   = {
      ...
      "tid":
      ["trackedParam_tid_SF_DM0", "trackedParam_tid_SF_DM10", "trackedParam_tid_SF_DM1", "trackedParam_tid_SF_DM11"],
    ...
    fulllist = compare.get('norm',[]) + compare.get('shapes',[]) + compare.get('rateParam',[]) + compare.get('tid',[])
