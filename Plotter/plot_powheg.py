...
from config.samples_v12_powheg import *
...
def plot(sampleset,setup,parallel=True,tag="",extratext="",outdir="plots",era="",
  ...
  CMSStyle.setCMSEra(era,cmsText="CMS", extra="Preliminary")
  ...
  if 'tau' in channel: # mutau, etau, tautau
    ...
    variables += [
      Var('m_vis',          40,  0, 200, fname="mvis",ctitle={'mumu':"m_mumu",'emu':"m_emu"},logy=False, cbins={"nbtag\w*>":(60,0,300)}),
      Var('m_vis',          36,  20, 200, fname="mvis_200_5",ctitle={'mumu':"m_mumu",'emu':"m_emu"},logy=False),
      Var('m_vis',          18,  20, 200, fname="mvis_200_10",ctitle={'mumu':"m_mumu",'emu':"m_emu"},logy=False),
      Var('m_vis',          30,  0, 300, fname="mvis_300",ctitle={'mumu':"m_mumu",'emu':"m_emu"},logy=False),
      Var('m_vis',          12,  40, 160, fname="mvis_160",ctitle={'mumu':"m_mumu",'emu':"m_emu"},logy=False),
      ...
      Var('rawDeepTau2018v2p5VSjet_2', "rawDeepTau2018v2p5VSjet", 80, 0.96, 1, ymin = 1e2, fname="$VAR_zoom3",ncols=2,pos='L;y=0.85'),
      Var('leadTkPtOverTauPt_2', "leadTkPtOverTauPt", 50, 0.00, 2, ymin = 1e3, ncols=2,pos='L;y=0.85',logy=True,ymargin=1.5),
    ...
    variables += [
      ...
      Var('m_ll', "m_mumu", 75, 50,  200, fname="$VAR_5bin", veto=["m_vis>200"] ),
      Var('m_ll', "m_mumu", 80, 50,  130, fname="$VAR_50_130_2", veto=["m_vis>200"] ),
    ]
